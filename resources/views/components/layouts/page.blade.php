...
<body>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        ...
                        <span class="d-none d-md-block dropdown-toggle ps-2">{{ Auth::user()->user_id }}</span> </a><!-- End Profile Iamge Icon -->
    ...
    <aside id="sidebar" class="sidebar" style="background-color: #0A335D; padding-right: unset;">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.html" style="border-radius: unset;">
                    <span class="fs-5 fw-bold" style="color: #0A335D;">Dashboard</span>
                </a>
            </li>
            <!-- End Dashboard Nav -->
