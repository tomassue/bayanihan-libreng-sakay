                ...
                <div class="row g-2">
                    ...
                    <div class="col-sm-12 col-lg-9 mb-4">
                        <form wire:submit="search">
                            ...
                            <div class="row g-2 mb-2">
                                <label for="inputEvent" class="col-sm-1 col-md-2 col-lg-2 col-form-label">Event</label>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row g-2 mb-2 mt-2">
                            <div class="col-sm-4 text-start">
                                <!-- <a href="{{ route('pdf-events', ['start_date' => $start_date, 'end_date' => $end_date, 'acct_type' => $query_acc_type]) }}" target="_blank"> -->
