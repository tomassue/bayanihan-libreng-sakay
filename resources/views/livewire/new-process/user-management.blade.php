        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #0A335D; color: #FFFFFF  ">
                    <h1 class="modal-title fs-5 fw-bolder" id="addUserModalLabel">Status History</h1>
                ...
                <div class="modal-footer" wire:loading.remove>
                    <button type="submit" class="btn btn-success fw-bolder mt-2" style="width: auto;" data-bs-dismiss="modal" wire:click="clear">Save</button>
                    </form>
                </div>
            </div>
        </div>
