            ...
            <div class="modal-content">
                ...
                <div class="modal-body" wire:loading.remove>
                    <form class="row g-3" data-bitwarden-watching="1" novalidate wire:submit="{{ $editMode ? 'update' : 'add' }}">
                        ...
                        @elseif($account_type == 'car')
                        <div class="separator">
                            <span class="fs-5">Rider (Car)</span>
                        </div>
                        ...
                        @if ($account_type == 'rider' || $account_type == 'car')
                        <div class="col-md-12">
                        ...
                        @if ($account_type == 'rider' || $account_type == 'organization' || $account_type == 'car')
                        <div class="col-md-12">
